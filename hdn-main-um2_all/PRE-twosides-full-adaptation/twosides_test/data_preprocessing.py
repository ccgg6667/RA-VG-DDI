...
id_data_dict = pkl.load(open('/cmy_project/code/hdn-main-um2_all/PRE-twosides-full-adaptation/twosides_test/twosides/id_data_dict_dsn_full_connect.pkl', 'rb'))

df_drugs_smiles = pd.read_csv('/cmy_project/code/hdn-main-um2_all/PRE-twosides-full-adaptation/twosides_test/twosides/drug_smiles.csv')
...
df_all_pos_ddi = pd.read_csv('/cmy_project/code/hdn-main-um2_all/PRE-twosides-full-adaptation/twosides_test/twosides/ddis.csv')
