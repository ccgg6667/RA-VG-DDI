...
def build_parser():
    ...
    parser.add_argument('--n_epochs', type=int, default=260, help='num of epochs')
    ...
    parser.add_argument('--node_gate_mode', type=int, default=2, choices=[0, 1, 2], help='0=off, 1=partner_substructure_gate, 2=partner_relation_gate')
...
def test(test_data_loader, model, device):
    ...
    print('\n')
    print('============================== Test Result ==============================')
    print(f'\t\ttest_acc: {test_acc:.4f}, test_roc: {test_auc_roc:.4f}, test_f1: {test_f1:.4f}, test_aupr: {test_ap:.4f}, test_precision: {test_precision:.4f},test_recall: {test_recall:.4f},test_int_ap: {test_int_ap:.4f},test_ap: {test_ap:.4f}')
...
def main():
    ...
    df_ddi_train = pd.read_csv(f'/cmy_project/code/RA-VG-DDI-main/hdn-main-um2_all/PRE-twosides-full-adaptation/drugbank_test/DrugBank/warm_start/fold{args.fold}/train.csv')
    df_ddi_test = pd.read_csv(f'/cmy_project/code/RA-VG-DDI-main/hdn-main-um2_all/PRE-twosides-full-adaptation/drugbank_test/DrugBank/warm_start/fold{args.fold}/test.csv')
