...
id_data_dict = pkl.load(open('/cmy_project/code/RA-VG-DDI-main/hdn-main-um2_all/PRE-twosides-full-adaptation/drugbank_test/DrugBank/id_data_dict_dsn_full_connect.pkl', 'rb'))

df_drugs_smiles = pd.read_csv('/cmy_project/code/RA-VG-DDI-main/hdn-main-um2_all/PRE-twosides-full-adaptation/drugbank_test/DrugBank/drug_smiles.csv')
...
df_all_pos_ddi = pd.read_csv('/cmy_project/code/RA-VG-DDI-main/hdn-main-um2_all/PRE-twosides-full-adaptation/drugbank_test/DrugBank/ddis.csv')
...
class DrugDataset(Dataset):
    ...
    def collate_fn(self, batch):
        ...
        for h, t, r in batch:
            ...
            pos_b_graph = self._create_b_graph(get_bipartite_graph(h_data,t_data),h_data.x,t_data.x)
        ...
        for i in range(len(neg_h_test)):
            ...
            neg_b_graph = self._create_b_graph(get_bipartite_graph(neg_h_samples[i],neg_t_samples[i]),neg_h_samples[i].x,neg_t_samples[i].x)
