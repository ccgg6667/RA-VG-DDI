...
def main():
    ...
    df_ddi_train = pd.read_csv(f'/cmy_project/code/hdn-main-um2_all/PRE-twosides-full-adaptation/twosides_test/twosides/fold{args.fold}/train.csv')
    df_ddi_test = pd.read_csv(f'/cmy_project/code/hdn-main-um2_all/PRE-twosides-full-adaptation/twosides_test/twosides/fold{args.fold}/test.csv')
